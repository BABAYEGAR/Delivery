 ...
 */
        ...
        Responsive.prototype = {
            ...
            _constructor: function() {
                ...
                $(window)
                    .on("resize.dtr orientationchange.dtr",
                ...
                var display = $.map(columns,
                    function(col) {
                        return col.auto && col.minWidth === null
                            ? false
                            : col.auto === true ? "-" : $.inArray(breakpoint, col.includeIn) !== -1;
                    });
        ...
        Responsive.defaults = {
            ...
            details: {
                renderer: function(api, rowIdx) {
                    var data = api.cells(rowIdx, ":hidden")
                        .eq(0)
                        .map(function(cell) {
...
// Doesn't do anything - work around for a bug in DT... Not documented
        ...
        Api.register("responsive.rebuild()",
            function() {
