...
/***/ function(module, exports, __webpack_require__) {
                    ...
                    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [
                            __webpack_require__(1), __webpack_require__(3), __webpack_require__(4)
...
/***/ function(module, exports, __webpack_require__) {
                    ...
                    var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
                    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ =
                            function(eve) {
                                ...
                                function R(first) {
                                    if (R.is(first, "function")) {
                                        ...
                                        return R._engine.create[apply](R, first.splice(0, 3 + R.is(first[0], nu)))
                                            .add(first);
                                    } else {
                                ...
                                var loaded,
                                    ...
                                    apply = "apply",
                                    concat = "concat",
                                    supportsTouch = ("ontouchstart" in g.win) ||
                                        g.win
                                        .DocumentTouch &&
                                        g.doc instanceof DocumentTouch, //taken from Modernizr touch test
                                    E = "",
                                    S = " ",
                                    Str = String,
                                    split = "split",
                                    events =
                                        "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[split](S),
                                    touchMap = {
                                    ...
                                    rectPath = R._rectPath = function(x, y, w, h, r) {
                                        if (r) {
                                            return [
                                                ["M", x + r, y], ["l", w - r * 2, 0], ["a", r, r, 0, 0, 1, r, r],
                                                ["l", 0, h - r * 2], ["a", r, r, 0, 0, 1, -r, r], ["l", r * 2 - w, 0],
                                                ["a", r, r, 0, 0, 1, -r, -r], ["l", 0, r * 2 - h],
                                                ["a", r, r, 0, 0, 1, r, -r], ["z"]
                                            ];
                                        }
                                    ...
                                    ellipsePath = function(x, y, rx, ry) {
                                        ...
                                        return [
                                            ["M", x, y], ["m", 0, -ry], ["a", rx, ry, 0, 1, 1, 0, 2 * ry],
                                ...
                                R.getColor = function(value) {
                                    var start = this.getColor
                                            .start = this.getColor.start || { h: 0, s: 1, b: value || .75 },
                                ...
                                var pathDimensions = R.pathBBox = function(path) {
                                    ...
                                    pathToRelative = R._pathToRelative = function(pathArray) {
                                        ...
                                        if (!R
                                            .is(pathArray, array) ||
                                            !R.is(pathArray && pathArray[0], array)) { // rough assumption
                                    ...
                                    a2c =
                                        function(x1, y1, rx, ry, angle, large_arc_flag, sweep_flag, x2, y2, recursive) {
                                            ...
                                            if (!recursive) {
                                                ...
                                                var rx2 = rx * rx,
                                                    ...
                                                    k = (large_arc_flag == sweep_flag ? -1 : 1) *
                                                        math
                                                        .sqrt(abs((rx2 * ry2 - rx2 * y * y - ry2 * x * x) /
                                                            (rx2 * y * y + ry2 * x * x))),
                                ...
                                (function(matrixproto) {
                                    ...
                                    matrixproto.toString = function() {
                                        return R.svg
                                            ? "matrix(" +
                                            [
                                                this.get(0), this.get(1), this.get(2), this.get(3), this.get(4), this
                                                .get(5)
                                            ]
                                            .join() +
                                            ")"
                                            ...
                                            return function(obj, type, fn, element) {
                                                ...
                                                if (supportsTouch && touchMap[type]) {
                                                    var _f = function(e) {
                                                        ...
                                                        for (var i = 0, ii = e.targetTouches && e.targetTouches.length;
                                                            i < ii;
                                                            i++) {
                                            ...
                                            if (R.is(fn, "function")) {
                                                ...
                                                this.events
                                                    .push({
                                                        ...
                                                        f: fn,
                                                        unbind:
                                                            addEvent(this.shape || this.node || g.doc,
                                                                eventName,
                                                                fn,
                                                                scope || this)
                                                    });
                               ...
                               \*/
                                ...
                                elproto.drag = function(onmove, onstart, onend, move_scope, start_scope, end_scope) {
                                    function start(e) {
                                        ...
                                        eve("raphael.drag.start." + this.id,
                                ...
                                paperproto.image = function(src, x, y, w, h) {
                                    var out = R._engine
                                        .image(this, src || "about:blank", x || 0, y || 0, w || 0, h || 0);
                                    this.__set__ && this.__set__.push(out);
                                    return out;
                                };
                                /*\
                                                ...
                                                if (p[0] == "M") {
                                                    ...
                                                    if (len + l > length) {
                                                        if (subpath && !subpaths.start) {
                                                            ...
                                                            sp +=
                                                            [
                                                                "C" + point.start.x, point.start.y, point.m.x,
                                                                point.m.y,
                                                                point.x, point.y
                                                            ];
                                                            if (onlystart) {
                                                            ...
                                                            sp =
                                                            [
                                                                "M" + point.x, point.y + "C" + point.n.x, point.n.y,
                                                    ...
                                                    if (from[has](attr)) {
                                                        ...
                                                        case "path":
                                                            ...
                                                            for (var i = 0, ii = from[attr].length; i < ii; i++) {
                                                                now[i] = [from[attr][i][0]];
                                                                for
                                                                (var j = 1, jj = from[attr][i].length; j < jj; j++) {
                                                                    now[i][j] =
                                                        ...
                                                        case "transform":
                                                            if (diff[attr].real) {
                                                                ...
                                                                for (i = 0, ii = from[attr].length; i < ii; i++) {
                                                                    now[i] = [from[attr][i][0]];
                                                                    for
                                                                    (j = 1, jj = from[attr][i].length; j < jj; j++) {
                                                                        now[i][j] =
                                                                            from[attr][i][j] +
                                ...
                                elproto.animateWith = function(el, anim, params, ms, easing, callback) {
                                    ...
                                    var a = params instanceof Animation
                                            ? params
                                            : R
                                ...
                                elproto.animate = function(params, ms, easing, callback) {
                                    ...
                                    var anim = params instanceof Animation
                                        ? params
                                ...
                                elproto.pause = function(anim) {
                                    for (var i = 0; i < animationElements.length; i++)
                                        if (animationElements[i].el.id == this.id &&
                                            ...
                                            if (eve("raphael.anim.pause." + this.id,
                                                    this,
                                                    animationElements[i]
                                                    .anim) !==
                                                false) {
                                ...
                                elproto.stop = function(anim) {
                                    for (var i = 0; i < animationElements.length; i++)
                                        if (animationElements[i].el.id == this.id &&
                                            (!anim || animationElements[i].anim == anim)) {
                                            if (eve("raphael.anim.stop." + this.id, this, animationElements[i].anim) !==
                                                false) {
                                                animationElements.splice(i--, 1);
                                            }
                                        }
                                ...
                                \*/
                                paperproto
                                    .print = function(x, y, string, font, size, origin, letter_spacing, line_spacing) {
                                        ...
                                        if (font) {
                                            ...
                                            for (var i = 0, ii = letters.length; i < ii; i++) {
                                                ...
                                                if (curr && curr.d) {
                                                    path += R
                                                        .transformPath(curr.d,
                                                        [
                                                            "t", shift * scale, shifty * scale, "s", scale, scale, top,
                                                            height, "t", (x - top) / scale, (y - height) / scale
                                                        ]);
                                                }
                                            }
                                        }
...
/***/ function(module, exports, __webpack_require__) {
                    ...
                    var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
                    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ =
                            function(R) {
                                if (R && !R.svg) {
                                    return;
                                }
                                    ...
                                    addDashes = function(o, value, params) {
                                        ...
                                        if (value) {
                                            var width = o.attrs["stroke-width"] || "1",
                                                butt = { round: width, square: width, butt: 0 }[
                                                ...
                                                case "clip-rect":
                                                    ...
                                                    if (!value) {
                                                        ...
                                                        if (path) {
                                                            var
                                                                clip = R._g.doc
                                                                    .getElementById(path.replace(/(^url\(#|\)$)/g, E));
                                                ...
                                                case "fill":
                                                    ...
                                                    if (!clr.error) {
                                                        ...
                                                        if ("opacity" in attrs || "fill-opacity" in attrs) {
                                                            var
                                                                gradient = R._g.doc
                                                                    .getElementById(node.getAttribute("fill")
                                                                        .replace(/^url\(#|\)$/g, E));
                                                            if (gradient) {
                                    ...
                                    tuneText = function(el, params) {
                                        ...
                                        var a = el.attrs,
                                            ...
                                            fontSize = node.firstChild
                                                ? toInt(R._g.doc.defaultView.getComputedStyle(node.firstChild, E)
                                ...
                                R.prototype.clear = function() {
                                    ...
                                    (this.desc = $("desc"))
                                        .appendChild(R._g.doc.createTextNode("Created with Rapha\xebl " + R.version));
                    ...
                    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ =
                            function(R) {
                                ...
                                var addArrow = function(o, value, isEnd) {
                                    ...
                                    setFillAndStroke = function(o, params) {
                                        ...
                                        if (params.path && o.type == "path" || newpath) {
                                            node
                                                .path =
                                                path2vml(~Str(a.path).toLowerCase().indexOf("r")
                                        ...
                                        if (params.opacity != null ||
                                            ...
                                            var stroke = (node.getElementsByTagName("stroke") &&
                                            ...
                                            params["stroke-linecap"] &&
                                            (stroke
                                                .endcap = params["stroke-linecap"] == "butt"
                                                ? "flat"
                                                : params["stroke-linecap"] == "square" ? "square" : "round");
                                            if ("stroke-dasharray" in params) {
                                                ...
                                                stroke
                                                    .dashstyle =
                                                    dasharray[has](params["stroke-dasharray"])
                                        ...
                                        if (res.type == "text") {
                                            ...
                                            res.textpath.string &&
                                            (span
                                                .innerHTML = Str(res.textpath.string)
                                                .replace(/</g, "&#60;")
                                                .replace(/&/g, "&#38;")
                                                .replace(/\n/g, "<br>"));
                                            ...
                                            (res.path.v = R
                                                .format("m{0},{1}l{2},{1}",
                                                    ...
                                                    round(a.x * zoom) + 1));
                                            var dirtyattrs = [
                                                "x", "y", "text", "font", "font-family", "font-weight", "font-style",
                                                "font-size"
                                            ];
                                ...
                                R._engine.create = function() {
                                    ...
                                    cs.cssText = R
                                        .format("top:0;left:0;width:{0};height:{1};display:inline-block;position:relative;clip:rect(0 {0} {1} 0);overflow:hidden", width, height);
                                    if (container == 1) {
