...
(function($, window, undefined) {
    ...
    var Backstretch = function(container, images, options) {
        ...
        this.$wrap = $existing.length
            ? $existing
            : $('<div class="backstretch"></div>').css(styles.wrap).appendTo(this.$container);
        ...
        $(window)
            ...
            .on("orientationchange.backstretch",
                $.proxy(function() {
            ...
            self.$img = $("<img />")
                ...
                .bind("load",
                    function(e) {
                        ...
                        $(this)
                            .fadeIn(self.options.speed || self.options.fade,
                                function() {
                                    oldImage.remove();
                                    ...
                                    $(["after", "show"])
                                        .each(function() {
                                            self.$container.trigger($.Event("backstretch." + this, evtOptions),
                                                [self, newIndex]);
                                        });
                                });
